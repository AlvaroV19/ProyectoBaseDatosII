    ...
    <ion-content>
      <ion-modal :is-open="modalIsOpen" @didDismiss="modalIsOpen = false" :css-class="['my-custom-modal']">
        <div id="modal-content">
          <div id="data-form">
            <InputComponent v-model="codigo" id="codigo" name="codigo" label="Codigo: " />
            <InputComponent v-model="nombre" id="nombre" name="nombre" label="Nombre: " />
            <InputComponent v-model="precio" type="number" id="precio" name="precio" label="Precio: " />
            <InputComponent v-model="stock" type="number" id="stock" name="stock" label="Stock: " />
...
// Rutas de la API
const baseURL = 'http://localhost:9000/backend/api/producto';
let productoJs = {
    codigo: '',
    nombre: '',
    precio: '',
